...
export const cargos = [
  {
    factory: 'UPS',
    product: 'TShirt',
    ship_date: '22.06.2020',
    estimated_time: '22.07.2020',
    price: '9.90 â‚º',
    user: 'John Dohn',
    phone: '32895721568',
...
export const tickets = [
  {
    id: 1,
    title: "About my new ticket",
    user : 3,
    messages: [
      {
        user: users[1],
        message: "My message is that dude",
        last_message: "Jan 20 , 2018",
      },
      {
        user: users[2],
        message: "My message is that 2 dude",
        last_message: "Jan 20 , 2018",
      },
      {
        user: users[1],
        message: "My message is that 3 dude",
        last_message: "Jan 20 , 2018",
      },
    ],
  },
  {
    id: 2,
    title: "About my new ticke2222t",
    user : 2,
    messages: [
      {
        user: users[1],
        message: "My message is that2222 dude",
        last_message: "Jan 20 , 2018",
      },
      {
        user: users[4],
        message: "My message is that 33332 dude",
        last_message: "Jan 20 , 2018",
      },
      {
        user: users[1],
        message: "My message is that 444443 dude",
        last_message: "Jan 20 , 2018",
      },
    ],
  }
