  ...
  <v-card class="neu-glow">
    <v-card-title class="text-subtitle-1 pb-0">
      <v-row class="mx-0" align="center" justify="space-between">
        <v-card-title class="text-subtitle-1 pa-0">{{ this.getTextEn("Operational.discoverWays") }}</v-card-title>
      </v-row>
    </v-card-title>
    <v-card-text>
  ...
  computed: {
    getMyData() {
      let myVar = {
        ...
        datasets: [
          {
            label: this.getTextEn("Operational.direct"),
          ...
          {
            label: this.getTextEn("Operational.organicSearch"),
          ...
          {
            label: this.getTextEn("Operational.other"),
